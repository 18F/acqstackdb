"""
Django settings for acqstackdb project.
...
SECRET_KEY = '2liv5a*jjtx9qu)ewqz+1riim6!wgz1z@yebwh70*extgqaz5i'
...
WSGI_APPLICATION = 'acqstackdb.wsgi.application'
